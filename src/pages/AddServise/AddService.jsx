    ...
    return (
        <div className="px-4 py-12 md:px-24">
            ...
            <div className="text-center mb-12">
                <p className="uppercase text-sm tracking-wider text-gray-400 mb-2">HomeRepairBD Provider Panel</p>
                <h1 className="text-4xl font-bold text-purple-600">Add Your Service</h1>
                <p className="text-gray-500 max-w-xl mx-auto mt-2 text-sm">Let customers find and hire you for your skills. Fill in the details carefully.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-16">
                {[
                    ...
                    <div key={i} className="bg-base-100 border border-base-300 p-6 rounded-xl text-center shadow hover:shadow-md transition">
                        {item.icon}
                        <h4 className="font-semibold mt-4 mb-1 text-lg text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600 bg-[length:200%_200%]">{item.title}</h4>
            ...
            {/* Provider Info */}
            <div className="flex items-center gap-4 bg-base-200 border border-base-300 rounded-lg p-4 max-w-md mx-auto mb-10">
                <img src={user?.photoURL} alt="Provider" className="w-12 h-12 rounded-full object-cover border" />
                <div>
                    <h4 className="font-semibold text-purple-600">{user?.displayName}</h4>
                    <p className="text-xs text-gray-500">{user?.email}</p>
                </div>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6 bg-white border border-base-300 rounded-xl shadow-xl p-8 md:p-10 transition-all duration-300 hover:shadow-2xl">
