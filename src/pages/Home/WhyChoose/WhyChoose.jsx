...
const features = [
    ...
    {
        icon: <PhoneCall className="text-purple-600 w-6 h-6" />,
        title: "24/7 Customer Support",
        desc: "Get help anytime through chat, phone, or email.",
    },
    {
        icon: <BadgeDollarSign className="text-yellow-600 w-6 h-6" />,
        ...
        <div className="mt-12">
            <section className=" py-12 text-center px-4">
                <div className="divider mb-12">
                    <h2 className="text-3xl font-bold text-center ">Why Choose HomeRepair<motion.span
                        animate={{
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className=" p-8 bg-amber-50 rounded-full relative">
                            <FaRegStar size={10} color='purple' className="text-green-500 animate-ping text-4xl absolute right-7" />
                            <img className='w-16 h-16 ' src="https://i.ibb.co/GvH5Nmzf/mortgage.png" alt="" />
                        </div>
                    </div>
