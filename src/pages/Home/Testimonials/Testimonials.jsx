...
const Testimonials = () => {
    ...
    <div className='mt-20 pb-20'>
        <div className='divider mb-12'><h1 className='sm:text-4xl text-2xl font-bold text-center'>What Our <span className=" font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600 bg-[length:200%_200%]">Clients</span>  Have To Say</h1></div>
