...
// const Footer = () => {
//   return (
//     <footer className="bg-blue-900 dark:bg-gray-800 text-white py-10 px-6 md:px-20">
...
//             We are dedicated to providing the best healthcare services with a team of expert professionals and advanced facilities to ensure your well-being.
//           </p>
//         </div>
...
//             <FaEnvelope /> support@healthcare.com
//           </p>
//         </div>
