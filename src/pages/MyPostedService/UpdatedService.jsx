            ...
            <form onSubmit={handleUpdateService} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <fieldset className="bg-base-200 border border-base-300 rounded-lg p-4">
                        ...
                        <input type="text" name="name" defaultValue={service.name} className="input  w-full" placeholder="Enter service name" required />
                    </fieldset>
                     {/* Image URL */}
                    <fieldset className="bg-base-200 0 border border-base-300 rounded-lg p-4">
                        <label className="block mb-1  font-medium">Image URL</label>
                        <input type="text" name="image" defaultValue={service.image} className="input   w-full" placeholder="Enter image URL" required />
                    </fieldset>

                    {/* Price */}
                    <fieldset className="bg-base-200 border border-base-300 rounded-lg p-4">
                        <label className="block mb-1 dark:text-white font-medium">Price ($)</label>
                        <input type="number" name="price" defaultValue={service.price} className="input  w-full" placeholder="Enter price" required />
                    </fieldset>

                    {/* Service Area */}
                    <fieldset className="bg-base-200  border border-base-300 rounded-lg p-4">
                        <label className="block mb-1  font-medium">Service Area</label>
                        <select name="area" defaultValue={service.area} className="select  w-full" required>
                    ...
                    <fieldset className="md:col-span-2 bg-base-200 dark:bg-gray-600 border border-base-300 rounded-lg p-4">
                        ...
                        <textarea name="description" defaultValue={service.description} rows="4" className="textarea  w-full" placeholder="Describe the service in detail" required></textarea>
                    </fieldset>
                </div>
