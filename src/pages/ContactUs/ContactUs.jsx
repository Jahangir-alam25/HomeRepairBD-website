...
const ContactUs = () => {
  return (
    <div className="bg-purple-50 min-h-screen py-10 px-5 md:px-20">
      {/* Page Title */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 text-center border-t-4 border-purple-500">
          ...
          <p className="text-gray-600">support@homerepairbd.com</p>
        </div>
      ...
      {/* Contact Form */}
      <div className="bg-white shadow-md rounded-lg p-8 max-w-3xl mx-auto border-t-4 border-purple-500">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg p-2 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-400"
            />
          </div>
          <div>
